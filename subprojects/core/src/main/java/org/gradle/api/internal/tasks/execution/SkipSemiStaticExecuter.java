 ...
 */
public class SkipSemiStaticExecuter implements TaskExecuter {
    private static final Logger LOGGER = Logging.getLogger(SkipSemiStaticExecuter.class);
    private final TaskExecuter executer;

    public SkipSemiStaticExecuter(TaskExecuter executer) {
    ...
    public void execute(TaskInternal task, TaskStateInternal state, TaskExecutionContext context) {
        ...
        if (skip) {
            LOGGER.info("Skipping {} as task enabled is false.", task);
